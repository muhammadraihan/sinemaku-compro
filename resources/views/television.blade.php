...
<section class="allfilms reveal">
  <div class="allfilms-head">
    <h2 class="allfilms-title">Televisi</h2>

    <div class="allfilms-filters" role="tablist" aria-label="Filter televisi by genre">
  ...
  <div class="allfilms-grid">
    ...
    @foreach ($genre as $item)
      <article class="filmitem" data-genres='@json($item->genres_array)'>
        {{-- <article class="filmitem" data-genre="{{ strtolower($item->genre) }}"> --}}
          <a href="{{ route('detail-tv', $item->slug) }}" class="filmitem-link">
    ...
    @endforeach
      ...
      <!-- Tambah series lain di sini, set data-genre sesuai: drama | thriller | sci-fi | romance -->
  </div>
</section>
