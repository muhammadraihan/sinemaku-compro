...
<div class="col-xxl">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>Tambah <span class="fw-300"><i>Kategori Event</i></span></h2>
        ...
        <div class="panel-container show">
            <div class="panel-content">
                ...
                @endif
                {!! Form::open(['route' => 'event-kategori.store', 'method' => 'POST', 'class' => 'needs-validation', 'novalidate']) !!}
                <div class="form-group col-md-6 mb-3">
                    {{ Form::label('name', 'Nama Kategori *', ['class' => 'form-label']) }}
                    {{ Form::text('name', null, ['placeholder' => 'Nama Kategori Event', 'class' => 'form-control '.($errors->has('name') ? 'is-invalid':''), 'required']) }}
