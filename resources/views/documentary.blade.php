...
@section('content')
    ...
    <style>
        ...
        /* Zig Zag Positions (Documentary Variant) */
        #leak-orange-1 {
        ...
        #leak-navy-1 {
            ...
            top: 45%;
            left: 0;
            animation: float-left 26s ease-in-out infinite;
            opacity: 0.15;
        }
        ...
        #leak-orange-2 {
            ...
            top: 70%;
            right: 0;
            animation: float-right 21s ease-in-out infinite;
        }
        ...
        #leak-navy-2 {
            ...
            top: 90%;
            left: 0;
            animation: float-left 24s ease-in-out infinite;
            opacity: 0.15;
        }
    </style>
