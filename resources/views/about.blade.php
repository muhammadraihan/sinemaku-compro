        ...
        <div class="w-full flex flex-col items-center text-center mb-20">
            <h2 class="manifesto-reveal flex flex-col items-center max-w-5xl mx-auto">
                ...
                <div class="flex flex-wrap justify-center gap-x-2 md:gap-x-4 gap-y-1 md:gap-y-2 items-baseline">
                    @php
                     $rawText ='[ps]KALAU DIPIKIR-PIKIR,[/ps] [s]yang bikin seseorang sampai ke titik tertentu sering kali bukan soal bakatnya, tapi soal apakah  dia pernah dapat[/s] [ps]kesempatan.[/ps] [s]Banyak cerita bagus yang akhirnya ga kemana-mana, bukan karena ceritanya kurang, tapi karena[/s] [ps]belum ketemu ruang buat didengar.[/ps]';
