...
@section('title', 'Casting Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Modul: <span class='fw-300'>Casting </span>
        <small>
            Modul Casting.
        </small>
    </h1>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Casting  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('casting.create')}}"><i class="fal fa-plus-circle">
                        </i>
...
<script>
    $(document).ready(function(){
       ...
       var table = $('#datatable').DataTable({
            ...
            {data: 'link', name: 'link'},
            {data: 'shoot_date', name: 'shoot_date'},
