            ...
            <div class="panel-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-id-article" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    {{ Form::text('title',null,['placeholder' => 'Excerpt','class' => 'form-control '.($errors->has('title') ? 'is-invalid':''),'required'])}}
                                </div>
                                <div class="form-group col-md-12 mb-3">
                        ...
                        <div class="tab-pane fade" id="tab-en-article" role="tabpanel">
                            <div class="row">
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    {{ Form::text('judul_en',null,['placeholder' => 'Article Title in English','class' => 'form-control'])}}
                                </div>
                                <div class="form-group col-md-12 mb-3">
                                    {{ Form::label('title_en','Excerpt / Ringkasan (EN)',['class' => 'form-label'])}}
                                    {{ Form::text('title_en',null,['placeholder' => 'Excerpt in English','class' => 'form-control'])}}
                                </div>
                                <div class="form-group col-md-12 mb-3">
                                    {{ Form::label('detail_en','Konten Artikel (EN)',['class' => 'form-label'])}}
                                    {{ Form::textarea('detail_en',null,['placeholder' => 'Article Content in English','class' => 'form-control', 'id' => 'detail_en'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-3">
                        ...
                        {{ Form::text('link',null,['placeholder' => 'https://...','class' => 'form-control '.($errors->has('link') ? 'is-invalid':''),'required'])}}
                    </div>
                </div>
                <div class="form-group col-md-4 mb-3">
