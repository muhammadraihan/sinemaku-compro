...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Modul: <span class='fw-300'>Article </span>
        <small>
            Modul Article.
        </small>
    </h1>
        ...
        <div id="panel-1" class="panel">
            ...
            <h2>
                ...
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('article.create')}}"><i class="fal fa-plus-circle">
                        </i>
