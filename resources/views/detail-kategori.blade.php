...
<style>
  ...
  .collection {
    width: var(--wrap);
    margin: clamp(20px, 5vw, 68px) auto 80px;
  }
  ...
  <div class="collection-grid">
    ...
    @foreach ($shop as $item)
      <article class="product-tile reveal">
        <a href="{{ route('detail-shop', $item->slug) }}" class="product-media"><img
            src="{{ asset('photo/' . $item->photo) }}" alt="{{ $item->name }}"></a>
