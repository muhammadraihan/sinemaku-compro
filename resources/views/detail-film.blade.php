    ...
    <div class="flex flex-col items-start gap-3 mt-8 md:mt-10">
        ...
        @if($video_id)
            <button
                ...
                class="inline-flex items-center px-4 py-2 -mt-3 rounded-md border border-[#F36B21] bg-[#F36B21] text-white shadow-sm font-sans text-xs font-bold tracking-widest uppercase transition-all duration-300 hover:bg-white hover:border-[#F36B21] hover:text-[#F36B21] cursor-none hover-target">
                Tonton Trailer
            </button>
        @endif
                </div>
