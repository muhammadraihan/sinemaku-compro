...
@section('title', $films->title . ' | Dokumenter | Sinemaku Pictures')
...
<section class="sec-stills">
  ...
  <div class="stills-slideshow" id="stills-documentary">
    ...
    <button class="slide-nav slide-nav--prev" onclick="slideMove('stills-documentary', -1)" aria-label="Previous">
      <svg viewBox="0 0 24 40"><path d="M20 4 L4 20 L20 36 Z" /></svg>
    </button>
    <button class="slide-nav slide-nav--next" onclick="slideMove('stills-documentary', 1)" aria-label="Next">
      <svg viewBox="0 0 24 40"><path d="M4 4 L20 20 L4 36 Z" /></svg>
    </button>
    <div class="slide-counter" id="stills-documentary-dots"></div>
  </div>
</section>
...
<section class="recommendations">
  ...
  <div class="rec-grid">
    @foreach ($all_film->take(4) as $item)
      <a class="rec-card" href="{{ route('detail-documentary', $item->slug) }}">
        <div class="rec-img">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() { initSlideshow('stills-documentary'); });
</script>
@endsection