        ...
        <section class="py-32 px-8 md:px-16 z-10 relative bg-brand-deepbreath text-white">
            ...
            @php
                ...
                if ($shots->count() == 0) {
                    ...
                    $shots = collect([
                        (object) ['photo' => 'https://picsum.photos/seed/d1/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/d2/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/d3/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/d4/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/d5/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/d6/1200/800'],
                    ]);
                }
