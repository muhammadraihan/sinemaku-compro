        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.catalogue-card').forEach(card => {
                ...
                card.addEventListener('mouseenter', () => {
                    ...
                    if (videoId) {
                        // Delay slighty so it doesn't spawn if user just fast-swipes the mouse over it
                        timeoutId = setTimeout(() => {
                            iframeContainer = document.createElement('div');
                            // The container matches the card size, and clips the oversized iframe
                            ...
                            // Calculate exact object-cover dimensions for 16:9
                            ...
                            // Scale up by 1.6 to push YouTube titles, logos, and controls completely out of the visible card area
                            ...
                            // Insert it right after the thumbnail image
