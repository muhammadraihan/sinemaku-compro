...
@section('title', 'Data User PHYK Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Modul: <span class='fw-300'>Data User PHYK </span>
        <small>
            Modul Data User PHYK.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Data User PHYK  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    {{-- <a class="nav-link active" href="{{route('phyk.create')}}"><i class="fal fa-plus-circle">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <form id="filter-form">
                        {!! Form::open(['route' => 'phyk.search','id'=>'forms','method' => 'GET','class' =>
...
<script>
    ...
    $(document).delegate("#search-btn", "click", function (event) {
        ...
        $(document).delegate("#export", "click", function (event) {
            ...
            var link = "{{ route('phyk.export') }}" + "?tgl_mulai=" + encodeURIComponent(tgl_mulai) + "&tgl_akhir=" + encodeURIComponent(tgl_akhir);
