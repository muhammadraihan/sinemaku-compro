    ...
    <div class="flex flex-col items-start gap-2 mt-12 md:mt-16">
        ...
        @if($video_id)
            ...
            onclick="openHeroTrailer('{{ $video_id }}')"
                class="inline-flex items-center px-4 py-2 -mt-2 rounded-md border border-[#F36B21] bg-[#F36B21] text-white shadow-sm font-sans text-xs font-bold tracking-widest uppercase transition-all duration-300 hover:bg-white hover:border-[#F36B21] hover:text-[#F36B21] cursor-none hover-target hero-reveal">
                Tonton Trailer
            </button>
        @endif
