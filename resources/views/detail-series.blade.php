        ...
        <section class="py-32 px-8 md:px-16 z-10 relative bg-brand-deepbreath text-white">
            ...
            @php
                ...
                if ($shots->count() == 0) {
                    ...
                    $shots = collect([
                        (object) ['photo' => 'https://picsum.photos/seed/s1/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/s2/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/s3/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/s4/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/s5/1200/800'],
                        (object) ['photo' => 'https://picsum.photos/seed/s6/1200/800'],
                    ]);
                }
