...
@section('content')
    ...
    EDITORIAL WRAPPER
    ============================================================ --}}
    <section id="editorial-wrapper" class="text-[#131b4d] relative w-full font-sans">
...
<div class="detail-hero-content relative z-20 px-8 md:px-16 pb-12 max-w-[1400px] mx-auto w-full">
    <div class="flex flex-col items-start gap-2 mt-8 md:mt-12">
        @php
            $video_id = '';
            if (
                !empty($films->link) &&
...
<div class="mb-4 pb-4 reveal-text">
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-6 reveal-text">
    ...
    <div>
        ...
        <div class="detail-credit-list space-y-1">
            @foreach($credits as $credit)
                <p class="detail-info-copy detail-credit-name font-sans text-base md:text-lg leading-7 text-[#131b4d]">
                    {{ $credit->name }}
                </p>
            @endforeach
        </div>
