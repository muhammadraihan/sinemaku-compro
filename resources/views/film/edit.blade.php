            ...
            <div class="panel-content">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('title_en',$film->title_en,['placeholder' => 'Judul (EN)','class' => 'form-control '.($errors->has('title_en') ? 'is-invalid':'')])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('genre_en',$film->genre_en,['placeholder' => 'Genre (EN)','class' => 'form-control '.($errors->has('genre_en') ? 'is-invalid':'')])}}
                ...
                <div class="form-group col-md-12 mb-3">
                    ...
                    {{ Form::textarea('sinopsis_en',$film->sinopsis_en,['placeholder' => 'Sinopsis (EN)','class' => 'form-control '.($errors->has('sinopsis_en') ? 'is-invalid':''), 'id' => 'sinopsis_en'])}}
